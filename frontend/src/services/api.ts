...
export const paperApi = {
  ...
  batchUpdate: (projectId: number, paperIds: number[], updates: Record<string, unknown>) =>
    api.post<{ updated: number; total: number }>(`/projects/${projectId}/papers/batch-update`, { paper_ids: paperIds, updates }).then(r => r.data),
