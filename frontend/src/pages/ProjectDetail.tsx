...
export default function ProjectDetail() {
  ...
  const navItems = [
    ...
    { path: 'reading-history', label: t('readingHistory.title', 'Reading History'), icon: BookOpen },
    ...
    { path: 'export', label: t('export.title', 'Export'), icon: Download },
    { path: 'ocr', label: t('ocr.title', 'OCR'), icon: Eye },
    { path: 'crawler', label: t('crawler.title', 'Crawler'), icon: Download },
    { path: 'dedup', label: t('dedup.title', 'Dedup'), icon: Files },
    { path: 'keywords', label: t('keywords.title', 'Keywords'), icon: Sparkles },
    { path: 'subscriptions', label: t('subscriptions.title', 'Subscriptions'), icon: Rss },
    { path: 'pipelines', label: t('pipelines.title', 'Pipelines'), icon: Network },
    { path: 'rag', label: t('rag.title', 'RAG'), icon: Brain },
    { path: 'contradictions', label: t('contradictions.title', 'Contradictions'), icon: AlertTriangle },
  ];
