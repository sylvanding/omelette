...
from app.models import Project, Paper, Keyword
...
async def list_projects(
    ...
    for p in projects:
        ...
        items.append(ProjectRead(
            ...
            settings=p.settings, created_at=p.created_at, updated_at=p.updated_at,
            paper_count=paper_count, keyword_count=kw_count,
        ))
...
async def create_project(body: ProjectCreate, db: AsyncSession = Depends(get_db)):
    ...
    return ApiResponse(
        ...
        data=ProjectRead(
            ...
            domain=project.domain, settings=project.settings,
...
async def get_project(project_id: int, db: AsyncSession = Depends(get_db)):
    ...
    return ApiResponse(data=ProjectRead(
        id=project.id, name=project.name, description=project.description,
        domain=project.domain, settings=project.settings,
        created_at=project.created_at, updated_at=project.updated_at,
        paper_count=paper_count, keyword_count=kw_count,
